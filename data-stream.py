...
def shutdown_hook(producer):
    try:
        ...
        logger.warn('Failed to flusj pending messages to kafka, cause by: %s', kafka_error.message)
    finally:
        try:
            producer.close(10)
...
if __name__ == '__main__':
    ...
    parser.add_argument('kafka_broker', help='the kafka tbroker.')
    ...
    # local[2]: use local computer and two threads
